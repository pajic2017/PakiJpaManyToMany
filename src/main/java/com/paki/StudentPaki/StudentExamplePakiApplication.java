...
import com.paki.StudentPaki.entity.Tag;
import com.paki.StudentPaki.repository.PostRepository;

@SpringBootApplication
public class StudentExamplePakiApplication implements CommandLineRunner {
	
	@Autowired
	private PostRepository postRepository;

	public static void main(String[] args) {
		SpringApplication.run(StudentExamplePakiApplication.class, args);
	}
